...
<html lang="en">
	<head>
		<title>Sistema de Calificaciones :: Error 500</title>
		...
		<div id="content">
					...
					<div class="section-body contain-lg">
						<div class="row">
							<div class="col-lg-12 text-center">
								...
								<h2 class="text-light">Ocurrió un error</h2>
							</div><!--end .col -->
						</div><!--end .row -->
				...
				<section>
					<div class="section-body contain-md">
						<div class="col-lg-12 text-center">
							<a class="btn btn-primary" href="<?=base_url()?>"><i class="fa fa-home"></i> Regresar a la página principal</a>
						</div>
					</div><!--end .section-body -->
				</section>
				<!-- END SEARCH SECTION -->
