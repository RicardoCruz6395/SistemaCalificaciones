...
<html lang="en">
	<head>
		<title>Sistema de cursos - Olvide mi contraseña</title>
	...
	<body class="menubar-hoverable header-fixed ">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-sm-12">
							...
							<form class="form form-validate" id="form_password_forgot" action="<?=base_url('auth/postPassword_forgot')?>" accept-charset="utf-8" method="post">
								<div class="form-group floating-label">
									<input type="email" id="email" class="form-control" name="email" required="">
									<label for="email">Correo electrónico</label>
									<p class="help-block" style="position: absolute;">Te enviaremos un correo con las instrucciones.</p>
								</div>
								<div class="form-group floating-label">
										<div class="input-group-btn">
											<button class="btn btn-primary btn-submit" type="submit"><i class="fa fa-unlock"></i> Enviar solicitud</button>
		...
		<script>	
		$('#form_password_forgot').submit(function(e) {
			var $this = $(this);
			e.preventDefault();
			start();
